...
All fields are the same as [Create KPI](./create-kpi.md) with the following notes:
...
### Confirming Changes
- Visit [KPI Details](./view-kpi.md) page
...
<EditButton docSlug="infrastructure/edit-kpi" docTitle="Edit KPI" />
