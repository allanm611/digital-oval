...
- **Core Features** - Main platform capabilities like campaigns, offers, and segments
- **Analytics** - Reporting and performance monitoring
- **Configuration** - System setup and customization
- **Infrastructure** - Technical setup and integrations
...
1. **Start with Campaigns** - Understand how campaigns work first
2. **Build Segments** - Create customer segments for targeted messaging
