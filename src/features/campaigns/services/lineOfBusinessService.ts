...
class LineOfBusinessService {
  private baseUrl = buildApiUrl("/lines-of-business");
  ...
  async getLinesOfBusiness(): Promise<ConfigurationItem[]> {
  ...
  async getLineOfBusinessById(id: number): Promise<ConfigurationItem> {
