...
function EditDocsPageContent() {
  ...
  const isViewingOldVersion = selectedVersion !== null && selectedVersion !== 0;
  ...
  useEffect(() => {
    ...
    if (!isAddMode && slug) {
      ...
      setVersions([
        { version: 1, created_at: '2026-05-20', created_by: 'Admin', summary: 'Initial version' },
        { version: 2, created_at: '2026-05-23', created_by: 'Admin', summary: 'Updated content' },
        { version: 3, created_at: '2026-05-26', created_by: 'Admin', summary: 'Current version' },
      ]);
    }
    setLoading(false);
  }, [slug, isAddMode]);
  ...
  */
  ...
  const handleRollback = async () => {
    showToast('success', 'Version rolled back successfully');
  };
