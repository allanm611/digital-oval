...
1. Go to [Product List](/documentation/products/products-list) to see existing products
2. Click on a product to [View Details](/documentation/products/view-product-details)
3. Ready to add products? Follow [Create Product](/documentation/products/create-product) for step-by-step instructions
4. Check [Product Reports](/documentation/products/product-reports) to see how your products are performing in campaigns
