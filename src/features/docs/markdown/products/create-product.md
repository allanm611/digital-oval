...
The Create Product form guides you through setting up a new product that can be used in your system. The same form is used for both creating new products and editing existing ones when editing, all fields are pre-filled with current values based on your edit permissions.
