...
Reward Types are categories used to classify and organize the different kinds of rewards you can offer to customers. Reward types help standardize how rewards are defined and managed in your system.
...
Reward Types are managed by your system and backend. You can view and edit existing reward types, but creation and deletion are handled at the system level.
