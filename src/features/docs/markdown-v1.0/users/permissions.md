...
![Permissions Management List](/img/v1.0/usermanagement-images/permissionsmanagementlist.png)
...
![Create Permission Form](/img/v1.0/usermanagement-images/createpermission.png)
