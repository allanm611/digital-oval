...
![Offer Catalogs List](/img/v1.0/configuration/offercataloglist.png)
...
![Create Offer Catalog](/img/v1.0/configuration/createoffercatalog.png)
...
![View Offers in Catalog](/img/v1.0/configuration/viewoffersinacatalog.png)
...
![Assign Offers to Catalog](/img/v1.0/configuration/assignofferstoacatalog.png)
