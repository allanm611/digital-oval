...
![Communication Policy List](/img/v1.0/configuration/communicaitonpolicylist.png)
...
![Create Policy Button](/img/v1.0/configuration/communicaitonpolicylist.png)


![Create Policy Form](/img/v1.0/configuration/createpolicy.png)
...
![Policy Type Selection](/img/v1.0/configuration/createpolicy-policydropdown.png)
...
![Maximum Communication Policy](/img/v1.0/configuration/createpolicy-maximum.png)
...
![DND Policy](/img/v1.0/configuration/createpolicy-dnd.png)
...
![VIP Policy](/img/v1.0/configuration/createpolicy-vip.png)
