...
![Combo Types List](/img/v1.0/configuration/combotypeslist.png)
...
![Create Combo Type Form - Part 1](/img/v1.0/configuration/createcombotypeimage1.png)

![Create Combo Type Form - Part 2](/img/v1.0/configuration/createcombotypeimage2.png)
