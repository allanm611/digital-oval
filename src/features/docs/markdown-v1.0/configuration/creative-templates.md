...
![Creative Templates List](/img/v1.0/configuration/creativetemplatelistimage.png)
...
![Create Creative Template - Name and Description](/img/v1.0/configuration/createcreativetemplatename-decsriptionimage.png)

![Create Creative Template - Template Configuration](/img/v1.0/configuration/createcreativetemplate-templateconfigsection.png)

![Create Creative Template - Template Content](/img/v1.0/configuration/createcreativetemplate-templatecontentsection.png)
