...
![Seed List Management Page](/img/v1.0/configuration/seedlistmanagementpage.png)
...
![Add Seed Recipient Modal - Part 1](/img/v1.0/configuration/addseedlistmodalimage1.png)

![Add Seed Recipient Modal - Part 2](/img/v1.0/configuration/addseedlistmodalimage2.png)
