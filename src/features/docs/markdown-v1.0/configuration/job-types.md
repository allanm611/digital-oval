...
![Job Types List](/img/v1.0/configuration/jobtypeslistimage.png)
...
![Create Job Type](/img/v1.0/configuration/createjobtypeimage.png)
...
![Edit Job Type](/img/v1.0/configuration/editjobtypeimage.png)
