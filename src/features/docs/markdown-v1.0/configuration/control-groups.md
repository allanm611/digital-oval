...
![Control Groups List](/img/v1.0/configuration/controlgroupslist.png)
...
![Create Control Group - Step 1](/img/v1.0/configuration/createcontrolgroupstep1.png)

![Create Control Group - Step 1 Saved Segments](/img/v1.0/configuration/createcontrolgroupstep1savedsegemnts.png)

![Create Control Group - Step 2](/img/v1.0/configuration/createcontrolgroupstep2.png)

![Create Control Group - Step 3](/img/v1.0/configuration/createcontrolgroupstep3.png)
