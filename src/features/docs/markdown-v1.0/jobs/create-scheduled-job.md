...
![Scheduled job create type selection modal](/img/v1.0/jobmanagement-images/selectwhichjobtorunmodalscheduledjobscreate.png)
...
![Scheduled job create form with basic info and campaign configuration](/img/v1.0/jobmanagement-images/createformscheduledjobimage1basicinfoand%20campaignconfiguration.png)

![Scheduled job create form additional configuration](/img/v1.0/jobmanagement-images/createscheduledjobimage2.png)
...
![Scheduled job schedule configuration](/img/v1.0/jobmanagement-images/scheduledetailscheduleconfiguration.png)
