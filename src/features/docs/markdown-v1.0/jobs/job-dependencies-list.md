...
![Job dependencies list page](/img/v1.0/jobmanagement-images/jobdepencieslistpage.png)
...
![Job dependency list page showing actions dropdown](/img/v1.0/jobmanagement-images/jobdepencylistpageshowingtheactionsdropdown.png)

![Job dependencies bulk operations](/img/v1.0/jobmanagement-images/jobdepenciesbulkopeartiosn.png)
