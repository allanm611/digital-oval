...
This route (`/dashboard/workflows/:id/edit`) reuses the Create Job Workflow page component.
...
![Job workflow details (edit context)](/img/v1.0/jobmanagement-images/jobworkflowdetailimage2.png)
