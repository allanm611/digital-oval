...
![Create job dependency form](/img/v1.0/jobmanagement-images/createjobdepency.png)
...
![Edit job dependency form](/img/v1.0/jobmanagement-images/editjobdependency.png)
