...
![Create Product Form](/img/v1.0/product-images/createproductimage1.png)
...
![Product Type Selection](/img/v1.0/product-images/createproduct-productypedropdown.png)

### Combo-Specific Fields

#### Shared Checkboxes (When Combo Type Selected)

![Combo Type - Unchecked Resources](/img/v1.0/product-images/createproduct-combotypeuncheckedresources.png)
...
![Combo Type - Shared Checkboxes](/img/v1.0/product-images/createproduct-combotypewith%20sharedcheckoxes.png)

#### Add Combo Resources

![Combo Type Selected](/img/v1.0/product-images/createproduct-combotypeselected.png)
...
![Product Category Dropdown](/img/v1.0/product-images/createproductimage2-productcategorydrodpodown.png)
...
![Edit Product Form](/img/v1.0/product-images/editproduct.png)
