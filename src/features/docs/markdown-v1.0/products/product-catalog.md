...
![Product Catalogs List](/img/v1.0/product-images/productcatalogslist.png)
...
- **Unused Categories** - Show only catalogs with no products
...
Each catalog card shows the total number of products, including the count of active products. Click **View Products** to:
