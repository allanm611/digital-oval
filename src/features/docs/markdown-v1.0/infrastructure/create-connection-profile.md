...
![Create Connection Profile - Basic Information](/img/v1.0/infrastructure/createconnectionprofilebasicinfo.png)
...
![Create Connection Profile - Classification and Metadata](/img/v1.0/infrastructure/createconnecitonprofiledatagovernnace.png)
...
![Create Connection Profile - Performance and Reliability](/img/v1.0/infrastructure/createconnectionprofileperfomancesettings.png)


![Create Connection Profile - Health Checks and Advanced](/img/v1.0/infrastructure/createconnecitonprofilehealthchecksandadvanced.png)
