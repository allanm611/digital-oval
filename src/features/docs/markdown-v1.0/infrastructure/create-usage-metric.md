...
![Create Usage Metric - Form Section 1](/img/v1.0/infrastructure/createusagemetricimage1.png)


![Create Usage Metric - Form Section 2](/img/v1.0/infrastructure/createusagemetricimage2.png)
