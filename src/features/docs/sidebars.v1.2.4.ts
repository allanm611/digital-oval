  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        "administration/communication-channels",
        {
          type: "category",
          label: "Routes",
          items: [
            ...
            "administration/sms-routes",
            "administration/email-routes",
            "administration/push-routes",
            "administration/whatsapp-routes",
            "administration/ussd-routes",
          ],
        },
        "administration/sender-ids",
        {
          type: "category",
          label: "KPIs",
          items: [
        ...
        },
        {
          ...
          items: [
            "administration/control-groups-overview",
            "administration/control-groups-list",
            "administration/create-control-group",
            "administration/view-control-group",
          ],
        },
        "administration/notification-types-list",
        "administration/dynamic-message-variables",
        "administration/timezones",
        "administration/gateway-configurations",
        "administration/execution-monitoring",
      ],
    },
    {
      type: "category",
      ...
      items: [
        ...
        "configuration/campaign-types",
        {
          ...
          items: [
            {
              type: "doc",
              id: "configuration/dnd-management",
              label: "Overview",
            },
        ...
        },
        {
          ...
          items: [
            {
              type: "doc",
              id: "configuration/seed-list-management-overview",
              label: "Overview",
            },
            {
              type: "doc",
              id: "configuration/seed-list-management-lists",
              label: "Manage Seed Lists",
            },
            {
              type: "doc",
              id: "configuration/seed-list-management-recipients",
