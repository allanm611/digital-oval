...
![Campaign Analytics Stat Cards](/img/v1.1/campaign-images/campaignanalyticsstatcards.png)
...
![Organization Overview](/img/v1.1/campaign-images/campaignanalytics-organizationoverview.png)
...
![Approval Status & Control Group Distribution](/img/v1.1/campaign-images/campaignanalyticspiecharts.png)
...
![Campaign Status Distribution](/img/v1.1/campaign-images/campaignanalytics-camapignsttausdistribution.png)
...
![Targets Distribution](/img/v1.1/campaign-images/campaignanalytics-targetsdistribution.png)
...
![Activity Status Overview](/img/v1.1/campaign-images/campaignanalytics-activitystatus.png)
...
![Budget Distribution](/img/v1.1/campaign-images/campaignanalytics-budgetdistribution.png)
...
![Participant Metrics](/img/v1.1/campaign-images/campaignanalytics-participantmetrics.png)
...
![Top Campaigns by Spend](/img/v1.1/campaign-images/campaignanalytics-topcamapignsbyspend.png)
...
![Recent Campaign Activity](/img/v1.1/campaign-images/campaignanalytics-recentactivity.png)
...
1. Navigate to **Campaign Management** → **Campaign Analytics**
2. View summary metrics at the top
3. Scroll down to see distribution charts and detailed analytics
4. Charts display only when there is data available

### Interpreting Charts

- **Pie charts** show proportional distribution across categories
