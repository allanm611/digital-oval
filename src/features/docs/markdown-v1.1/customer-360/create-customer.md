...
![Single Entry Form Part 1](/img/v1.1/customer360-images/addcustomermanuallyimage1.png)

![Single Entry Form Part 2](/img/v1.1/customer360-images/addcustomermanuallyimage2.png)
...
![Bulk CSV Entry](/img/v1.1/customer360-images/addcustomerbulkimage.png)
...
![Column Mapping](/img/v1.1/customer360-images/addcustomerimportimage1.png)

If mapping is incorrect, you'll see an error and have an option to go back and fix it :

![Column Mapping Error](/img/v1.1/customer360-images/addcustomerimportinvalidmappingimageerror.png)

4. Review preview of data to import

![File Import Preview](/img/v1.1/customer360-images/addcustomerimportvalidmappingimage.png)

![File Import Valid Preview](/img/v1.1/customer360-images/addcustomerimportvalidmappingimage.png)
