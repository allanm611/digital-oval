...
The Segment Analytics page provides comprehensive insights into your segment portfolio, including growth trends, distribution patterns, usage metrics, and segment health. This page helps you understand how segments are being used across the system and identify optimization opportunities.

## Summary Statistics Cards

At the top of the page, four key metric cards give you a quick health overview:

![Analytics Summary Statistics](/img/v1.1/segments-img/segmentanalyticsstatcards.png)

### Total Segments

- **Metric:** Total number of segments in the system
...
![Type Distribution & Category Distribution](/img/v1.1/segments-img/segmentanalyticstypeandcategorydistribution.png)
...
![Creation Trend Chart](/img/v1.1/segments-img/segmentanalyticscreationtrend.png)
...
![Top Largest Segments](/img/v1.1/segments-img/segmentanaltyicstoplargest.png)
...
![Campaign Usage Chart](/img/v1.1/segments-img/segmentanalyticscampaignusage.png)

**What It Shows:**

- The 10 segments used most frequently in campaigns
- Shows how many campaigns actively reference each segment
- Different from size—measures _usage_, not _member count_
<!--
...
![Stale Segments Table](/img/v1.1/segments-img/segmentanalyticsstalesegments.png)
