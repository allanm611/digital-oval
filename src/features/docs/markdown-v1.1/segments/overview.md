...
1. Go to [Segment List](/documentation/segments/segments-list) to see existing segments
2. Click on a segment to [View Details](/documentation/segments/view-segment-details)
3. Ready to create segments? Follow [Create Segment](/documentation/segments/create-segment) for step-by-step instructions
4. Check [Segment Reports](/documentation/segments/segment-reports) to analyze your segments
5. Use segments in campaigns to target specific customer groups
