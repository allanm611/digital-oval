...
![Segment Catalogs List](/img/v1.1/segments-img/segmentcatalogslist.png)
...
![Create Segment Catalog Modal](/img/v1.1/segments-img/createsegmentcatalog.png)
...
![View Segments in Catalog Modal](/img/v1.1/segments-img/viewsegmentsincatalogmodal.png)

Click the **View Segments** button on any catalog card to open the View Segments modal. This modal displays:

- All segments assigned to this catalog
...
![Assign Segments to Catalog Modal](/img/v1.1/segments-img/assignsegmentstosegmentcatalog.png)
...
- **Unused Categories** - Show only catalogs with no segments
...
Each catalog card shows the total number of segments, including the count of active segments. Click **View Segments** to:
