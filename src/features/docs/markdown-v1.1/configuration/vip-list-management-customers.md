...
4. Click **Save** to add them to the VIP list
...
- **Active** - Customer is currently in the VIP list. Include them in VIP policies and special handling.
- **Inactive** - Customer has been removed from the VIP list. They will no longer be treated as VIP.
