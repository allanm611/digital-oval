...
![Offer Details Overview](/img/v1.1/offer-images/offerdetailsimage1%20details.png)
...
![Offer Information](/img/v1.1/offer-images/offerdetailsofferinformation.png)

## Linked Products

Shows all products included in this offer with management options.

![Linked Products](/img/v1.1/offer-images/offerdetailslinkedproducts.png)
...
![Offer Creatives](/img/v1.1/offer-images/offerdetailsoffercreatives.png)
...
![Add Creative Modal](/img/v1.1/offer-images/offercreativesaddmodal.png)
...
To quickly create a new offer based on the current one, use the **Duplicate Offer** action at the top right of the offer detail page.

![Duplicate Offer on Detail Page](/img/v1.1/offer-images/duplicateofferonofferdetails.png)

This opens the offer creation form pre-filled with all details from the current offer. Make any changes needed and save to create the new offer.

## Used in Campaigns

Shows all campaigns currently using this offer.

![Used in Campaigns](/img/v1.1/offer-images/offerdetailsusedincampaigns.png)
