...
Global Search is a powerful app-wide search feature that lets you quickly find any item across the entire platform—campaigns, offers, products, segments, users, configurations, and more—from anywhere in the systemlication. Search results are categorized by type and you can drill down using filters on the search results page.
...
![Global Search Dropdown](/img/v1.1/getstarted/search.png)
...
![Search Results Page](/img/v1.1/getstarted/searchresults.png)
