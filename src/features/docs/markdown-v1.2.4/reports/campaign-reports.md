...
![Campaign Report Stats Cards](/img/v1.1/reports/campaignreportstats.png)
...
![Campaign Performance Table](/img/v1.1/reports/campaigntable.png)
...
- **TARGET GROUP CONVERSIONS** - Number of conversions from target group customers
- **CONTROL GROUP CONVERSIONS** - Number of conversions from control group customers
- **TARGET GROUP %** - Conversion percentage for target group
- **CONTROL GROUP %** - Conversion percentage for control group
