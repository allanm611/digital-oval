...
![Create QuickList Form](/img/v1.1/segments-img/createquicklistimage1.png)
...
![File Upload and Configuration](/img/v1.1/segments-img/createquicklistimage2.png)
...
![Edit QuickList Modal](/img/v1.1/segments-img/editquicklist.png)
