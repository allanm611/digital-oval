...
![Scheduled Jobs list page](/img/v1.1/jobmanagement-images/scheduledjobslistpage.png)
...
![Scheduled Jobs bulk operation page](/img/v1.1/jobmanagement-images/scheduledjobsbulkoperationpage.png)
...
![Select job type modal for scheduled job create](/img/v1.1/jobmanagement-images/selectwhichjobtorunmodalscheduledjobscreate.png)
