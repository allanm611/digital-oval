...
![Create Server - Basic Information](/img/v1.1/infrastructure/addserverbasicinfoimage1.png)
...
![Create Server - Connection Settings and Health Checks](/img/v1.1/infrastructure/addserverconnectionsettingsandhealthchecks.png)
![Create Server - Circuit Breaker](/img/v1.1/infrastructure/addservercircuitbreaker.png)
![Create Server - Advanced and TLS](/img/v1.1/infrastructure/adserveradvancedandtls.png)
