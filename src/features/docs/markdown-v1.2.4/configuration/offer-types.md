...
Offer types can be enabled or disabled by administrators in the Offer Types configuration page. Only active types are available for selection when creating or editing offers. Deactivated types are hidden from all offer creation and editing flows until reactivated.
