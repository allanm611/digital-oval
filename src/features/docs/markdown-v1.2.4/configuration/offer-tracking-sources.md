...
![Offer Tracking Sources List](/img/v1.1/configuration/offertrackingsourceslist.png)
...
![Create Offer Tracking Source](/img/v1.1/configuration/createoffertrackingimage1.png)

![Tracking Type Dropdown](/img/v1.1/configuration/createoffertrackingtypedropdown.png)

![Tracking Source Dropdown](/img/v1.1/configuration/createoffertrackingimagedropdownsource.png)
