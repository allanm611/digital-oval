...
![Campaign Catalogs List](/img/v1.1/configuration/campaigncatalogslist.png)
...
![Create Campaign Catalog](/img/v1.1/configuration/createcampaigncatalog.png)
...
![View Campaigns in Catalog](/img/v1.1/configuration/viewcampaignsincatalog.png)
...
![Assign Campaigns to Catalog](/img/v1.1/configuration/assigncampaignstocatalog.png)
