      ...
      <div className={`bg-white ${tw.rounded} w-full max-w-md shadow-xl`}>
        ...
        <div className="p-6 space-y-4">
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              >
                <Megaphone className={`h-5 w-5`} style={{ color: 'white' }} />
              </div>
              <div>
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              >
                <Database className={`h-5 w-5`} style={{ color: 'white' }} />
              </div>
              <div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 bg-gray-50">
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold text-white ${tw.rounded} disabled:opacity-50 disabled:cursor-not-allowed transition-colors`}
            style={{
