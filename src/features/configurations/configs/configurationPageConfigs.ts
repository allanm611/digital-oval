...
export const utilitiesConfig: TypeConfigurationPageConfig = {
  ...
  initialData: [
    ...
    },
    {
      ...
      name: "Insurance",
      value: "insurance",
      description: "Device protection, travel, and health insurance coverage",
      isActive: true,
      created_at: "2025-01-01T00:00:00Z",
      updated_at: "2025-01-01T00:00:00Z",
    },
    {
      ...
      description: "Music and audio streaming service access",
      isActive: true,
      created_at: "2025-01-01T00:00:00Z",
      updated_at: "2025-01-01T00:00:00Z",
    },
    {
      ...
      name: "Movies",
      value: "movies",
      description: "Movie and video streaming service access",
      isActive: true,
      created_at: "2025-01-01T00:00:00Z",
      updated_at: "2025-01-01T00:00:00Z",
    },
  ...
  metadataFields: [
    {
      ...
      type: "text",
      required: true,
      placeholder: "e.g., food, insurance, music_streaming",
    },
  ],
