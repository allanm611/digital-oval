...
import { 
  Trash2, Edit, X, PlayCircle, AlertTriangle, CheckCircle, Loader2, 
  Info, Settings, Database, Activity, Shield, RefreshCw, ExternalLink,
...
export default function DataConnectorDetailsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'config' | 'profiles'>('overview');
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-8">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Connector Not Found</h2>
          <p className="text-gray-600">The data connector you're looking for doesn't exist.</p>
          <button
            ...
            {isEditMode ? (
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${connector.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                    {connector.is_active ? 'Active' : 'Inactive'}
                  </span>
                </div>
                <p className="text-gray-600 text-lg leading-relaxed">{connector.description || "No description provided"}</p>
              </div>
            )}
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900 capitalize">{connector.type}</p>
                </div>
              </div>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {connectionProfiles.filter(p => p.status === 'active').length}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              {testResult.error_details && (
                <div className="mt-2 p-3 bg-white/50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1 font-mono">{testResult.error_details}</p>
                </div>
              )}
              {testResult.response_time_ms && (
                <p className="text-sm text-gray-500 mt-3">
                  Response time: <span className="font-medium">{testResult.response_time_ms}ms</span>
                </p>
              )}
            </div>
            <button
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">Connection Profiles</h3>
                    <p className="text-gray-600 mt-1">Manage your connection profiles</p>
                  </div>
                  <button
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-gray-900">Connection test performed</p>
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    {isTesting && <Loader2 className="h-4 w-4 animate-spin text-gray-400" />}
                  </button>
                  <button
                    onClick={() => navigate(`/dashboard/data-connectors/${connector.id}/logs`)}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-gray-900">Edit Connector</span>
                    </div>
              ...
              {/* Connector Info */}
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Connector Information</h3>
                <div className="space-y-4">
                  <div>
                    <p className="text-sm text-gray-500">ID</p>
                    <p className="text-sm font-mono text-gray-900">{connector.id}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Created</p>
                    <p className="text-sm text-gray-900">{connector.created_at}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Last Updated</p>
                    <p className="text-sm text-gray-900">{connector.updated_at}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Type</p>
                    <p className="text-sm font-medium text-gray-900 capitalize">{connector.type}</p>
                  </div>
                </div>
              </div>
            </div>
