...
class KpiCategoryService {
  private baseUrl = buildApiUrl("/profile-dictionary/categories");
  ...
  async getKpiCategories(): Promise<ConfigurationItem[]> {
  ...
  async getKpiCategoryById(id: number): Promise<ConfigurationItem> {
  ...
  async deleteKpiCategory(id: number): Promise<void> {
...
export const kpiCategoryService = new KpiCategoryService();
