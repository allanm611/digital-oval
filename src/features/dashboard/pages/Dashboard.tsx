...
const OfferPages = {
  ...
  OfferCreativesPage: lazy(
    () =>
      import(
        /* webpackPrefetch: true */ "../../offers/pages/OfferCreativesPage"
      ),
  ),
...
const ProductPages = {
  ...
  ComboTypeFormPage: lazy(
    () =>
      import(
        /* webpackPrefetch: true */ "../../products/pages/ComboTypeFormPage"
      ),
  ),
...
const SettingsPages = {
  ...
  SMSRoutesPage: lazy(
    () =>
      import(/* webpackPrefetch: true */ "../../routes/pages/SMSRoutesPage"),
  ),
  SMSTestPage: lazy(
    () =>
    ...
    <DashboardLayout>
      ...
      >
        ...
        /> */}
          ...
          />
          <Route
            path="/offer-creatives"
            element={<OfferPages.OfferCreativesPage />}
          />
          <Route
        ...
        /> */}
          ...
          <Route
            ...
            element={<ProductPages.ComboTypeFormPage />}
          />
          <Route
            path="/combo-types/:id/edit"
            element={<ProductPages.ComboTypeFormPage />}
          />
          <Route
            path="/combo-types/:id"
