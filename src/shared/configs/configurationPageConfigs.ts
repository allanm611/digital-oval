...
const hardcodedCharacterSets: TypeConfigurationItem[] = [
  ...
  },
  {
    ...
    description: "Central and Eastern European languages",
    isActive: true,
    metadataValue: "ISO-8859-2",
    created_at: "2025-01-17T11:00:00Z",
    updated_at: "2025-01-19T13:30:00Z",
  },
  {
  ...
  },
  {
    ...
    description: "Greek language character encoding",
    isActive: true,
    metadataValue: "ISO-8859-7",
    created_at: "2025-01-20T14:20:00Z",
    updated_at: "2025-01-23T09:30:00Z",
  },
  {
    ...
    description: "Hebrew language character encoding",
    isActive: true,
    metadataValue: "ISO-8859-8",
    created_at: "2025-01-21T10:15:00Z",
    updated_at: "2025-01-24T11:00:00Z",
  },
  {
    ...
    description: "Turkish language character encoding",
    isActive: true,
    metadataValue: "ISO-8859-9",
    created_at: "2025-01-22T12:00:00Z",
    updated_at: "2025-01-25T14:00:00Z",
  },
  {
    ...
    description: "Updated Western European encoding with Euro symbol",
    isActive: true,
    metadataValue: "ISO-8859-15",
    created_at: "2025-01-23T13:30:00Z",
    updated_at: "2025-01-26T15:30:00Z",
  },
  {
  ...
  },
  {
    ...
    description: "Windows Western European encoding",
    isActive: true,
...
export const characterSetsConfig: TypeConfigurationPageConfig = {
  ...
  metadataField: {
    label: "Encoding Code",
    type: "text",
    placeholder: "e.g., UTF-8, ISO-8859-1",
  },
  statusLabel: "Status",
